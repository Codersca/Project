...
public class loginController implements Initializable {
    ...
    private void Login() {
        ...
        try {
            ...
            e.printStackTrace();
            loginLabel.setText("Connection failed. " + e.getMessage());
    ...
    public void addUser() {
        try {
            ...
            signupConfirmationText.setText("Database Error: " + sqlEx.getMessage());
        } catch (Exception e) {
            e.printStackTrace();
            signupConfirmationText.setText("Error: " + e.getMessage());
        }
    }
    ...
    public static void limitTextField(TextField tf) {
        ...
        tf.textProperty().addListener((observable, oldValue, newValue) -> {
            ...
            if (tf.getText().length() > max) {
                tf.setText(tf.getText().substring(0, max));
            }
        });
    }
